...
#set the transformer output to pandas
...
if __name__ == "__main__":
    ...
    preprocessor = ColumnTransformer(transformers=[
        ...
        handle_unknown='ignore',sparse_output=False),nominal_cat_cols),
    ...
    logger.info("Datsets joined")

    #save the transfomred data
